  ...
  return (
    <div className="max-w-7xl mx-auto space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        {/* ThreatScore */}
        <div className="bg-surface-container/50 backdrop-blur-sm border border-outline-variant/60 rounded-2xl p-6 flex flex-col justify-between hover:border-primary/40 transition-colors relative overflow-hidden shadow-lg group">
          ...
          <div className="flex items-end gap-3">
            ...
            <span className="text-xs font-semibold text-passed bg-passed/10 px-2 py-1 rounded mb-1 border border-passed/20">
        ...
        {/* Total Findings */}
        <div className="bg-surface-container/50 backdrop-blur-sm border border-outline-variant/60 rounded-2xl p-6 flex flex-col justify-between hover:border-critical/30 transition-colors shadow-lg">
          <div className="flex justify-between items-start mb-4">
            <span className="text-xs font-label text-on-surface-variant uppercase tracking-wider">
              Total Findings
            </span>
        ...
        {/* Scanned Resources */}
        <div className="bg-surface-container/50 backdrop-blur-sm border border-outline-variant/60 rounded-2xl p-6 flex flex-col justify-between hover:border-secondary/30 transition-colors shadow-lg">
          <div className="flex justify-between items-start mb-4">
            <span className="text-xs font-label text-on-surface-variant uppercase tracking-wider">
              Scanned Resources
            </span>
        ...
        {/* Active Policies */}
        <div className="bg-surface-container/50 backdrop-blur-sm border border-outline-variant/60 rounded-2xl p-6 flex flex-col justify-between hover:border-high/30 transition-colors shadow-lg">
          <div className="flex justify-between items-start mb-4">
            <span className="text-xs font-label text-on-surface-variant uppercase tracking-wider">
              Active Policies
            </span>
          ...
          <div className="flex items-end gap-3">
            ...
            <span className="text-xs text-passed mb-1 font-medium">
              4 Frameworks Active
            </span>
          </div>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
        ...
        <div className="lg:col-span-8 bg-surface-container/50 backdrop-blur-sm border border-outline-variant/60 rounded-2xl p-6 shadow-lg">
          <div className="flex justify-between items-center mb-6">
            ...
            <button
              ...
              className="text-xs font-label text-primary hover:text-primary-fixed-dim hover:underline flex items-center gap-1"
            >
          ...
          {/* Severity Bar Chart */}
          <div className="h-56 flex items-end gap-6 px-4 pb-6 pt-4 border-b border-l border-outline-variant/50 relative">
            {/* Critical */}
        ...
        <div className="lg:col-span-4 bg-surface-container/50 backdrop-blur-sm border border-outline-variant/60 rounded-2xl p-6 shadow-lg flex flex-col justify-between">
          <div>
          ...
          <div className="pt-4 border-t border-outline-variant/40 mt-4 flex items-center justify-between text-xs text-on-surface-variant font-label">
            <span>Next Automated Scan:</span>
            <span className="text-on-surface font-mono">Today, 23:00 UTC</span>
          </div>
        </div>
      </div>
      ...
      <div className="bg-surface-container/50 backdrop-blur-sm border border-outline-variant/60 rounded-2xl p-6 shadow-lg">
        ...
        <div className="overflow-x-auto">
          <table className="w-full text-left text-sm whitespace-nowrap">
            <thead className="bg-surface-container-low text-on-surface-variant font-medium text-xs font-label border-b border-outline-variant/50">
              <tr>
            ...
            <tbody className="divide-y divide-outline-variant/30">
              {criticalAndHigh.map((f) => (
                ...
                >
                  ...
                  <td className="py-3 px-4">
                    <span className="px-2 py-0.5 bg-surface-container rounded text-xs font-mono border border-outline-variant/40">
                      {f.service_name}
                    </span>
                  </td>
